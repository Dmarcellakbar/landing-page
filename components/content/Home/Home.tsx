  ...
  return (
    ...
    <VStack paddingTop={'20%'}>
        <Container style={{ width: '100%', maxWidth: '80rem' }}>
            ...
            <Col lg={6}>
                <div>
                <Text marginTop={10} as={'b'} fontSize='3rem' p={'90px 0px 2rem'} color={'#01E8AA'}>The Best Management Firm Any Crypto Investor Can Dream of</Text>
                <Text marginTop={10} marginBottom={10} fontSize='1xl' color={'white'} pb={'2rem'}>
                    ...
                    <HStack spacing='10px' p={'2rem 0px 90px'}>
                        <Box>
